...
const ProductListingByTagItem = props => {
  const {
    product: {
      title,
      handle,
      ...
      {({ contributor }) => {
        return (
          <ProductListingItemLink to={`/product/${handle}`}>
            <Item>
              <Preview>
                <Image loading='eager' durationFadeIn={500} fluid={fluid} />
...
ProductListingByTagItem.propTypes = {
  product: PropTypes.object.isRequired
};

export default ProductListingByTagItem;
